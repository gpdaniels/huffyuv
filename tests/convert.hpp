...
inline std::unique_ptr<unsigned char[]> rgb_to_rgba(std::size_t width, std::size_t height, const unsigned char* pixels_rgb) {
...
inline std::unique_ptr<unsigned char[]> rgba_to_rgb(std::size_t width, std::size_t height, const unsigned char* pixels_rgba) {
...
inline std::unique_ptr<unsigned char[]> bgra_to_rgba(std::size_t width, std::size_t height, const unsigned char* pixels_bgra) {
    std::unique_ptr<unsigned char[]> pixels_rgba = std::unique_ptr<unsigned char[]>(new unsigned char[width * height * 4]);
    for (std::size_t y = 0; y < height; ++y) {
        for (std::size_t x = 0; x < width; ++x) {
...
inline std::unique_ptr<unsigned char[]> rgba_to_bgra(std::size_t width, std::size_t height, const unsigned char* pixels_rgba) {
...
inline std::unique_ptr<unsigned char[]> bgr_to_rgb(std::size_t width, std::size_t height, const unsigned char* pixels_bgr) {
    std::unique_ptr<unsigned char[]> pixels_rgb = std::unique_ptr<unsigned char[]>(new unsigned char[width * height * 3]);
    for (std::size_t y = 0; y < height; ++y) {
        for (std::size_t x = 0; x < width; ++x) {
...
inline std::unique_ptr<unsigned char[]> rgb_to_bgr(std::size_t width, std::size_t height, const unsigned char* pixels_rgb) {
...
inline std::unique_ptr<unsigned char[]> rgb_to_yuv(std::size_t width, std::size_t height, const unsigned char* pixels_rgb) {
...
inline std::unique_ptr<unsigned char[]> yuv_to_rgb(std::size_t width, std::size_t height, const unsigned char* pixels_yuv) {
    constexpr static const auto clip = [](int value) {
        const int shifted = (320 + ((value + 0x8000) >> 16));
        if (shifted < 320) {
            return 0;
